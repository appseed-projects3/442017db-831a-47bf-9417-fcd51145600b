...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-24 14:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/442017db-831a-47bf-9417-fcd51145600b.git
$ cd 442017db-831a-47bf-9417-fcd51145600b
```
